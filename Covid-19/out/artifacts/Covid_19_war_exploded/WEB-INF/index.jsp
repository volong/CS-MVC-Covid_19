                ...
                <div class="row">
                    ...
                    <c:forEach items="${requestScope['news']}" var="news">
                        <div class="col-md-6 clearfix visible-md visible-lg">
                            <div class="post">
                                <a class="post-img" href="/home?action=news&id=${news.getId()}"><img
                                        class="img-responsive" src="${news.getImg()}" alt=""></a>
                                <div class="post-body">
                                    <h3 class="post-title"><a
                                            href="/home?action=news&id=${news.getId()}">${news.getTitle()}</a></h3>
                                    <ul class="post-meta">
                                        <li>${news.getDate()}</li>
                                    </ul>
                                </div>
            ...
            <div class="aside-widget">
                <div>
                    ...
                    <div style="border:2px solid black; box-sizing: border-box; height: 250px">
                        <iframe class="embed-responsive-item" src="https://datawrapper.dwcdn.net/6TcVK/5/"
                                style="border: none" height="400px" width="1136px"></iframe>
                    </div>
                </div>
            </div>
        </div>
